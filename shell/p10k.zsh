# Generated by Powerlevel10k configuration wizard on 2024-09-03 at 18:21 CEST.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_NAME}:${P9K_KUBECONTEXT_CLOUD_ZONE}:${P9K_KUBECONTEXT_NAMESPACE}'
